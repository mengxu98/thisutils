...
building blocks for research workflows: sparse-matrix conversion and
top-k selection, correlations, neighborhoods and LISI scores, repeated
execution with structured messages, and optional dependency checks —
with explicit semantics and bounded resource use.
