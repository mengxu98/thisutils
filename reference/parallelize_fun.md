...
- export_fun:
  ...
  Character vector naming functions or other objects from the
  environment of `fun` that PSOCK workers need. Objects referenced from
  a global environment are not discovered automatically; list them here
  or include them in each element of `x`.
...
- progress:
  ...
  Whether to draw a dynamic terminal progress bar. The default follows
  `verbose`. Set this to `FALSE` while keeping `verbose = TRUE` to emit
  concise lifecycle messages through
  [`log_message()`](https://mengxu98.github.io/thisutils/reference/log_message.md)
  without terminal timing output, for example in reports and persistent
  logs.
...
#> ℹ [2026-09-12 01:30:11] Using 1 core
#> ⠙ [2026-09-12 01:30:11] Running for 1 [1/3] ■■■         33% | ETA:  0s
#> ✔ [2026-09-12 01:30:11] Completed 3 tasks in 631ms
#> 
#> ℹ [2026-09-12 01:30:11] Building results
#> $`1`
#> [1] 1
#> 
#> $`2`
...
#> ℹ [2026-09-12 01:30:12] Using 2 cores
#> ⠙ [2026-09-12 01:30:12] Running for [1/3] ■■■         33% | ETA:  2s
#> ✔ [2026-09-12 01:30:12] Completed 3 tasks in 1.3s
#> 
#> ℹ [2026-09-12 01:30:12] Building results
#> [[1]]
#> [1] 1
#> 
#> [[2]]
...
#> ℹ [2026-09-12 01:30:13] Using 1 core
#> ℹ [2026-09-12 01:30:13] Building results
#> ! [2026-09-12 01:30:13] Found 1 failed result
#> Warning: Found 1 failed result
#> ℹ [2026-09-12 01:30:13] ✖ Error details:
...
#> ℹ [2026-09-12 01:30:13] ✖ Error details:
#> ℹ                       ✖ Error on element 3 (1): "3"
#> ℹ [2026-09-12 01:30:13] Removed 1 failed result
#> $`1`
#> [1] 1
#> 
#> $`2`
...
#> ℹ [2026-09-12 01:30:13] Using 1 core
#> ℹ [2026-09-12 01:30:13] Building results
#> ! [2026-09-12 01:30:13] Found 2 failed results
#> Warning: Found 2 failed results
#> ℹ [2026-09-12 01:30:14] ✖ Error details:
...
#> ℹ [2026-09-12 01:30:14] Using 1 core
#> ℹ [2026-09-12 01:30:14] Building results
#> ! [2026-09-12 01:30:14] Found 1 failed result
#> Warning: Found 1 failed result
#> $`1`
#> [1] 1
#> 
