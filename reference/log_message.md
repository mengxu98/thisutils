...
#> ℹ [2026-09-09 10:44:38] Hello, world!
...
#> ✔ [2026-09-09 10:44:38] Hello, world!
...
#> ◌ [2026-09-09 10:44:38] Processing data...
...
#> ℹ [2026-09-09 10:44:38] `abc` is a argument
...
#> ℹ [2026-09-09 10:44:38] "list('abc')" is a <list>

log_message("{.code lm(y ~ x)} is a code example")
#> ℹ [2026-09-09 10:44:38] `lm(y ~ x)` is a code example

log_message("{.dt List}list('abc')")
#> ℹ [2026-09-09 10:44:38] List: list('abc')

log_message("address: {.email example@example.com}")
#> ℹ [2026-09-09 10:44:38] Address: example@example.com

log_message("{.emph R} is a programming language")
#> ℹ [2026-09-09 10:44:38] R is a programming language

log_message("{.envvar R_HOME}")
#> ℹ [2026-09-09 10:44:38] `R_HOME`

log_message("{.file log_message.R} is a file")
#> ℹ [2026-09-09 10:44:38] log_message.R is a file

log_message("{.fn lm} is a function")
#> ℹ [2026-09-09 10:44:38] `lm()` is a function

log_message("{.fun lm} is a function")
#> ℹ [2026-09-09 10:44:38] `lm()` is a function

log_message("{.help lm} to get help")
#> ℹ [2026-09-09 10:44:38] `?lm()` to get help

log_message("... see {.help [{.fun lm}](stats::lm)} to learn more")
#> ℹ [2026-09-09 10:44:38] ... see `lm()` (`?stats::lm()`) to learn more

log_message(
  "See the {.href [cli homepage](https://cli.r-lib.org)} for details"
)
#> ℹ [2026-09-09 10:44:38] See the cli homepage (<https://cli.r-lib.org>) for details

log_message("press {.kbd ENTER}")
#> ℹ [2026-09-09 10:44:38] Press [ENTER]

log_message("press {.key ENTER}")
#> ℹ [2026-09-09 10:44:38] Press [ENTER]

log_message("URL: {.url https://cli.r-lib.org}")
#> ℹ [2026-09-09 10:44:38] URL: <https://cli.r-lib.org>

log_message("Some {.field field}")
#> ℹ [2026-09-09 10:44:38] Some field

log_message("{.path /usr/bin/R} is a path")
#> ℹ [2026-09-09 10:44:38] /usr/bin/R is a path

log_message("{.pkg cli} is a package")
#> ℹ [2026-09-09 10:44:39] cli is a package

log_message("{.val object} is a variable")
#> ℹ [2026-09-09 10:44:39] "object" is a variable

log_message("{.run Rscript log_message.R} is a runnable file")
#> ℹ [2026-09-09 10:44:39] `Rscript log_message.R` is a runnable file

log_message("{.str object} is a string")
#> ℹ [2026-09-09 10:44:39] "object" is a string

log_message("{.strong abc} is a strong string")
#> ℹ [2026-09-09 10:44:39] abc is a strong string

log_message("{.topic stats::lm} is a topic")
#> ℹ [2026-09-09 10:44:39] `?stats::lm` is a topic

log_message("{.vignette cli} is a vignette")
#> ℹ [2026-09-09 10:44:39] `vignette(cli)` is a vignette


# set indentation
log_message("Hello, world!", level = 2)
#> ℹ [2026-09-09 10:44:39]   Hello, world!
...
#> ℹ [2026-09-09 10:44:39] This is a red message

log_message(
  "This is a message with background",
  back_color = "#EE4000"
)
#> ℹ [2026-09-09 10:44:39] This is a message with background
...
#> ℹ [2026-09-09 10:44:39] This is a message with both text and background
...
#> ℹ [2026-09-09 10:44:39] Bright red text

log_message(
  "Bright background",
  back_color = "br_yellow"
)
#> ℹ [2026-09-09 10:44:39] Bright background
...
#> ℹ [2026-09-09 10:44:39] Combined grey and style
...
#> ℹ [2026-09-09 10:44:39] Bold message

log_message(
  "Italic message",
  text_style = "italic"
)
#> ℹ [2026-09-09 10:44:39] Italic message

log_message(
  "Underlined message",
  text_style = "underline"
)
#> ℹ [2026-09-09 10:44:39] Underlined message

log_message(
  "Combined styles",
  text_style = c("bold", "underline")
)
#> ℹ [2026-09-09 10:44:39] Combined styles
...
#> ℹ [2026-09-09 10:44:39] Color and style
...
#> ℹ [2026-09-09 10:44:39] Hex color and style
...
#> ℹ [2026-09-09 10:44:39] Line 1
#> ℹ [2026-09-09 10:44:39] Line 2
#> ℹ [2026-09-09 10:44:39] Line 3
...
#> ℹ [2026-09-09 10:44:39] Multi-line
#> ℹ                       colored
#> ℹ                       message
...
#> ℹ [2026-09-09 10:44:39] Multi-line message
...
#> ℹ [2026-09-09 10:44:39] I am a green line with a blue substring that becomes green again!
...
fun()
#> ℹ [2026-09-09 10:44:39] "x"
#> ℹ [2026-09-09 10:44:39] 1
#> ℹ [2026-09-09 10:44:39] 2
...
#> ◌ [2026-09-09 10:44:39] This is standard output
#> ◌ [2026-09-09 10:44:39] This is a message
#> [1] 2
```
